        ...
        private List<AsigPermiso> Permisos(List<PermisoRol> permisos = null)
        {
            if(permisos == null || permisos.Count < 1)
                return new List<AsigPermiso> {
                    ...
                    new AsigPermiso("Contactos",false,false,false,false),
                    new AsigPermiso("Contactos","Index",false),
                    ...
                    new AsigPermiso("Productos",false,false,false,false),
                    new AsigPermiso("Productos","Index",false),
                    ...
                    new AsigPermiso("Movimientos",false,false,false,false),
                    new AsigPermiso("Movimientos","Index",false),
